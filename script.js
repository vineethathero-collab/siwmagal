        ...
        const timetableData = [
            ...
            { med: "Sinhala", country: "Sri Lanka", type: "Online", gender: "පුරුෂ", sec: "සිව්මග දරුවෝ", age: "අවු: 7 - 8", time: "ඉරිදා 5:30 - 7:00 pm", localTime: "ඉරිදා 5:30 - 7:00 pm", link: "https://zoom.us/mock-link-sivumaga-1", day: 0, startHour: 17, startMin: 30, endHour: 19, endMin: 0 },
            { med: "Sinhala", country: "Sri Lanka", type: "Online", gender: "පුරුෂ", sec: "සිව්මග දරුවෝ", age: "අවු: 9 - 10", time: "ඉරිදා 3:30 - 5:00 pm", localTime: "ඉරිදා 3:30 - 5:00 pm", link: "https://zoom.us/mock-link-sivumaga-2", day: 0, startHour: 15, startMin: 30, endHour: 17, endMin: 0 },
            { med: "Sinhala", country: "Sri Lanka", type: "Online", gender: "පුරුෂ", sec: "සිව්මග දරුවෝ", age: "අවු: 11 - 12", time: "ඉරිදා 3:30 - 5:00 pm", localTime: "ඉරිදා 3:30 - 5:00 pm", link: "https://zoom.us/mock-link-sivumaga-3", day: 0, startHour: 15, startMin: 30, endHour: 17, endMin: 0 },
            { med: "Sinhala", country: "Sri Lanka", type: "Online", gender: "පුරුෂ", sec: "සිව්මග දරුවෝ", age: "අවු: 13 - 16", time: "ඉරිදා 5:30 - 7:00 pm", localTime: "ඉරිදා 5:30 - 7:00 pm", link: "https://zoom.us/mock-link-sivumaga-4", day: 0, startHour: 17, startMin: 30, endHour: 19, endMin: 0 },
            { med: "Sinhala", country: "Sri Lanka", type: "Online", gender: "ස්ත්‍රී", sec: "සිව්මග දියණි", age: "අවු: 7 - 8", time: "ඉරිදා 5:30 - 7:00 pm", localTime: "ඉරිදා 5:30 - 7:00 pm", link: "https://zoom.us/mock-link-sivumaga-5", day: 0, startHour: 17, startMin: 30, endHour: 19, endMin: 0 },
            { med: "Sinhala", country: "Sri Lanka", type: "Online", gender: "ස්ත්‍රී", sec: "සිව්මග දියණි", age: "අවු: 9 - 10", time: "ඉරිදා 5:30 - 7:00 pm", localTime: "ඉරිදා 5:30 - 7:00 pm", link: "https://zoom.us/mock-link-sivumaga-6", day: 0, startHour: 17, startMin: 30, endHour: 19, endMin: 0 },
            { med: "Sinhala", country: "Sri Lanka", type: "Online", gender: "ස්ත්‍රී", sec: "සිව්මග දියණි", age: "අවු: 11", time: "ඉරිදා 7:00 - 8:30 pm", localTime: "ඉරිදා 7:00 - 8:30 pm", link: "https://zoom.us/mock-link-sivumaga-7", day: 0, startHour: 19, startMin: 0, endHour: 20, endMin: 30 },
            { med: "Sinhala", country: "Sri Lanka", type: "Online", gender: "ස්ත්‍රී", sec: "සිව්මග දියණි", age: "අවු: 13", time: "ඉරිදා 5:30 - 7:00 pm", localTime: "ඉරිදා 5:30 - 7:00 pm", link: "https://zoom.us/mock-link-sivumaga-8", day: 0, startHour: 17, startMin: 30, endHour: 19, endMin: 0 },
            { med: "Sinhala", country: "Sri Lanka", type: "Online", gender: "ස්ත්‍රී", sec: "සිව්මග දියණි", age: "අවු: 14", time: "ඉරිදා 7:00 - 8:30 pm", localTime: "ඉරිදා 7:00 - 8:30 pm", link: "https://zoom.us/mock-link-sivumaga-9", day: 0, startHour: 19, startMin: 0, endHour: 20, endMin: 30 },
            { med: "Sinhala", country: "Sri Lanka", type: "Online", gender: "ස්ත්‍රී", sec: "සිව්මග දියණි", age: "අවු: 15 - 16", time: "ඉරිදා 7:00 - 8:30 pm", localTime: "ඉරිදා 7:00 - 8:30 pm", link: "https://zoom.us/mock-link-sivumaga-10", day: 0, startHour: 19, startMin: 0, endHour: 20, endMin: 30 },
            { med: "Sinhala", country: "England", type: "Online", gender: "ස්ත්‍රී/පුරුෂ", sec: "සිව්මග පිටරට", age: "අවු: 7 - 11", time: "ඉරිදා 2:00 - 3:30 pm", localTime: "Sun. 9:30 - 11:00 am (BST)", link: "https://zoom.us/mock-link-sivumaga-11", day: 0, startHour: 14, startMin: 0, endHour: 15, endMin: 30 },
            { med: "Sinhala", country: "England", type: "Online", gender: "ස්ත්‍රී/පුරුෂ", sec: "සිව්මග පිටරට", age: "අවු: 12 - 16", time: "ඉරිදා 4:00 - 5:30 pm", localTime: "Sun. 11:30 am - 1:00 pm (BST)", link: "https://zoom.us/mock-link-sivumaga-12", day: 0, startHour: 16, startMin: 0, endHour: 17, endMin: 30 },
            ...
            { med: "Japan", country: "Japan", type: "Online", gender: "ස්ත්‍රී/පුරුෂ", sec: "Siwmaga International", age: "අවු: 5 - 10", time: "ඉරිදා 3:30 - 4:30 pm", localTime: "Sun. 7:00 - 8:00 pm (JST)", link: "https://zoom.us/mock-link-sivumaga-28", day: 0, startHour: 15, startMin: 30, endHour: 16, endMin: 30 },
            { med: "Japan", country: "Japan", type: "Online", gender: "ස්ත්‍රී/පුරුෂ", sec: "Siwmaga International", age: "අවු: 11 - 16", time: "ඉරිදා 3:30 - 4:30 pm", localTime: "Sun. 7:00 - 8:00 pm (JST)", link: "https://zoom.us/mock-link-sivumaga-29", day: 0, startHour: 15, startMin: 30, endHour: 16, endMin: 30 }
        ];
        ...
        function handleJoinClass(index) {
            ...
            if (isActive) {
                ...
                document.getElementById('class-status-title').innerText = "පන්තිය තවමත් සක්‍රීය නැත";
                document.getElementById('class-status-message').innerHTML = `
        ...
        function filterTimetable() {
            ...
            if (cardsContainer) {
                ...
                filteredData.forEach(item => {
                    ...
                    const btnLabel = isActive
                        ? `<span class="relative flex h-2 w-2"><span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-white opacity-75"></span><span class="relative inline-flex rounded-full h-2 w-2 bg-white"></span></span> සම්බන්ධ වන්න`
                        : `<i class="fa-solid fa-lock text-[10px] text-slate-400"></i> අගුළු දමා ඇත`;

                    let medLabel = '';
                    if (item.med === 'Sinhala') medLabel = 'සිංහල මාධ්‍යය';
                    else if (item.med === 'English') medLabel = 'English Medium';
                    else if (item.med === 'Japan') medLabel = 'Japan Medium';
                    ...
                    const card = `
                        <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-200/80 transition-all duration-300">
                            ...
                            <div class="grid grid-cols-2 gap-y-1.5 text-xs text-slate-600 mb-4">
                                <div><span class="font-bold text-slate-700">ස්ත්‍රී/පුරුෂ:</span> ${item.gender}</div>
                                <div><span class="font-bold text-slate-700">වයස:</span> ${item.age}</div>
                                <div class="col-span-2"><span class="font-bold text-slate-700">අංශය:</span> ${item.sec}</div>
                            </div>
                            <div class="bg-slate-50 p-3 rounded-xl border border-slate-100 flex flex-col gap-1.5 mb-3">
                                <div class="flex items-center justify-between">
                                    <span class="text-xs font-bold text-slate-500">ශ්‍රී ලංකා වේලාව:</span>
                                    <span class="text-xs font-bold text-amber-600">${item.time}</span>
                                </div>
                                <div class="flex items-center justify-between border-t border-slate-200/60 pt-1.5">
                                    <span class="text-xs font-bold text-slate-500">දේශීය වේලාව:</span>
            ...
            if (desktopTableBody) {
                ...
                filteredData.forEach((item, index) => {
                    ...
                    // Generate distinct badge markup for each medium shown dynamically during search
                    let rowMedLabel = '';
                    if (item.med === 'Sinhala') {
                        rowMedLabel = '<span class="ml-2 px-2.5 py-1 text-[10px] font-extrabold bg-amber-500/10 text-amber-600 rounded-md border border-amber-500/25">සිංහල</span>';
                        ...
                        rowMedLabel = '<span class="ml-2 px-2.5 py-1 text-[10px] font-extrabold bg-red-500/10 text-red-500 rounded-md border border-red-500/25">Japan</span>';
                    }
                    ...
                    const rowHTML = `
                        <tr class="t-row t-${item.med.toLowerCase()}">
                            ...
                            <td>${item.gender}</td>
                            <td>${item.sec}</td>
                            <td class="font-medium text-slate-700">${item.age}</td>
                            <td class="font-bold text-amber-600 text-xs">${item.time}</td>
        ...
        // High Quality News & Announcement Dataset (Featuring the new Japan Medium Class)
        const newsDataset = {
            'japan-class': {
                    ...
                    <div class="news-card flex-shrink-0 bg-white rounded-3xl overflow-hidden shadow-md flex flex-col border border-slate-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)]">
                        ...
                        <div class="p-6 flex flex-col flex-grow">
                            ...
                            <button onclick="openNewsModal('${key}')"
                                ...
                                වැඩිදුර කියවන්න <i class="fas fa-arrow-right text-[10px] transition-transform group-hover:translate-x-1"></i>
                            </button>
                        </div>
                    </div>
                `;
        ...
        (function () {
            ...
            function initializeFooterD3Map() {
                ...
                const locations = [
                    ...
                    { name: "England", coords: [-1.5, 52.5], flag: "https://flagcdn.com/w40/gb.png" },
                    ...
                    { name: "France", coords: [2.2137, 46.2276], flag: "https://flagcdn.com/w40/fr.png" }
                ];
